...
public partial class Saril : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        ...
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074186 : 1074183);
    }
}

[QuesterName("Cailla (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Cailla : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        ...
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074187 : 1074210);
    }
}

[QuesterName("Tamm (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Tamm : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        ...
        // Want a job?
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074213 : 1074187);
    }
}

[QuesterName("Landy (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Landy : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        ...
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074211 : 1074218);
    }
}

[QuesterName("Elder Alejaha (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Alejaha : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Mielan : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Hello there, can I have a moment of your time?
        // Have you done it yet?  Oh, I haven't told you, have I?
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074219 : 1074223);
    }
}

[QuesterName("Ciala (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Ciala : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        ...
        // Come here, I have a task.
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074206 : 1074186);
    }
}

[QuesterName("Aniel (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Aniel : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        ...
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074220 : 1074222);
    }
}

[QuesterName("Aulan (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Aulan : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        MLQuestSystem.Tell(
            ...
            {
                0 => 1074188, // Weakling! You are not up to the task I have.
                1 => 1074191, // Just keep walking away!  I thought so. Coward!  I'll bite your legs off!
                _ => 1074195  // You there, in the stupid hat!  Come here.
            }
        );
    }
}
...
[SerializationGenerator(0, false)]
public partial class Brinnae : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // *yawn* You busy?
        // Hi.  Looking for something to do?
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074212 : 1074210);
    }
}

[QuesterName("Elder Caelas (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Caelas : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Greetings seeker.  I have an urgent matter for you, if you are willing.
        // Waste not a minute! There's work to be done.
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074204 : 1074201);
    }
}

[QuesterName("Clehin (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Clehin : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // I could use some help.
        // Come here, I have a task.
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074211 : 1074186);
    }
}

[SerializationGenerator(0, false)]
public partial class Cloorne : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        ...
        // Come here, I have a task.
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074185 : 1074186);
    }
}

[QuesterName("Salaenih (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Salaenih : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Good day to you friend! Allow me to offer you a fabulous opportunity!  Thrills and adventure await!
        // Hey, could you help me out with something?
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074207 : 1074209);
    }
}

[QuesterName("Vilo (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Vilo : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Hi.  Looking for something to do?
        // May I call you friend?  I have a favor to beg of you.
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074210 : 1074220);
    }
}

[QuesterName("Tholef (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Tholef : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Tillanil : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Want a job?
        // Could I trouble you for some assistance?
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074187 : 1074222);
    }
}

[QuesterName("Waelian (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Waelian : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Greetings!  I have a small task for you good traveler.
        // Waste not a minute! There's work to be done.
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074221 : 1074201);
    }
}

[QuesterName("Sleen (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Sleen : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        ...
        // Excuse me please traveler, might I have a little of your time?
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074200 : 1074206);
    }
}

[QuesterName("Unoelil (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Unoelil : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Anolly : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Jusae : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Hi.  Looking for something to do?
        // Hey buddy.  Looking for work?
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074210 : 1074213);
    }
}

[QuesterName("Cillitha (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Cillitha : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Have you done it yet?' Oh, I haven't told you, have I?
        // Hey buddy.  Looking for work?
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074223 : 1074213);
    }
}

[QuesterName("Lohn (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Lohn : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Olla : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Thallary : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Greetings!  I have a small task for you good traveler.
        // *yawn* You busy?
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074221 : 1074212);
    }
}

[QuesterName("Ahie (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Ahie : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        ...
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074206 : 1074203);
    }
}

[SerializationGenerator(0, false)]
public partial class Tyeelor : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Athailon : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class ElderTaellia : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class ElderMallew : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class ElderAbbein : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class ElderVicaie : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class ElderJothan : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class ElderAlethanian : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Rebinil : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Aluniol : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Olaeni : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Bolaevin : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class LorekeeperAneen : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Daelas : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class Alelle : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class LorekeeperNillaen : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class LorekeeperRyal : BaseCreature
{
    [Constructible]
    ...
    public override void Shout(PlayerMobile pm)
    {
        // Greetings seeker.  I have an urgent matter for you, if you are willing.
        // Thank goodness you are here, there's no time to lose.
        MLQuestSystem.Tell(this, pm, Utility.RandomBool() ? 1074204 : 1074200);
    }
}

[QuesterName("Braen (The Heartwood)")]
[SerializationGenerator(0, false)]
public partial class Braen : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class ElderAcob : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class LorekeeperCalendor : BaseCreature
{
    [Constructible]
...
[SerializationGenerator(0, false)]
public partial class LorekeeperSiarra : BaseCreature
{
    [Constructible]
